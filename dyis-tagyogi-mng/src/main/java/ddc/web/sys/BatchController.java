...
import ddc.biz.sys.service.BatchService;
...
public class BatchController {
	...
	public ModelAndView selectBatchList(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView selectBatch(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView saveBatch(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
