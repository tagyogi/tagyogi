...
import ddc.biz.sys.service.WorkCloseService;
...
public class WorkCloseController {
	...
	public ModelAndView selectWorkCloseList(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView saveWorkClose(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
		LOGGER.debug("saveWorkClose START");
		JsonResult result = new JsonResult();
		 
		try {
			
			HashMap emp = workCloseService.selectEmp(paramMap);
			if(emp == null) {
	...
	public ModelAndView saveWorkCloseRevert(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
