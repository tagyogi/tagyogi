...
//	private TotalSearchInterceptor totalSearchInterceptor;
	...
	private static final String[] EXCLUDE_PATHS = {
			...
			"/index/index.do", "/index/accesFail.do", "/index/sessChk.do", "/login/**.do", "/com/**.do" , "/guar/updateGuarPrintAfter.do", "/invt/updateInvtBillIssue.do", "/invt/invtKeepIssueAfter.do", "/comConf/updateConfProcStat.do"
	};
