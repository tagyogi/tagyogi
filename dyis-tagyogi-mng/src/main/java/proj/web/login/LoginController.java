...
public class LoginController extends WebBaseController {
	...
	public ModelAndView login(HttpServletRequest request) {
		...
		if(!"local".equals(active)) {
			...
			HashMap<String, Object>codeDtl = comService.selectCodeDtl(setMap);
	...
	public ModelAndView loginProc(HttpServletRequest request, @RequestBody(required=false) HashMap<String, Object> paramMap) throws SocketException {
		...
		try {
			...
			//담당자 정보 조회
			HashMap<String, Object>getEmpMap = new HashMap<String, Object>(loginService.selectCmEmployee(paramMap));
	...
	public ModelAndView loginProcTmp(HttpServletRequest request, @RequestBody(required=false) HashMap<String, Object> paramMap) throws SocketException {
