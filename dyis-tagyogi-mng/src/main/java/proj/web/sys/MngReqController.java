...
import proj.biz.sys.service.MngReqService;
...
public class MngReqController {
	...
	public ModelAndView selectMngReqList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView selectMngReq(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
		LOGGER.debug("selectMngReq START");
		JsonResult result = new JsonResult();
		
		try {
			HashMap<String, Object>getMap = mngReqService.selectMngReq(paramMap);
	...
	public ModelAndView updateMngReqComent(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView updateMngReqProc(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView deleteMngReq(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
