...
import proj.biz.sys.service.DocService;
...
public class DocController {
	...
	public ModelAndView selectDocList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView selectDocFileList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView deleteDoc(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
