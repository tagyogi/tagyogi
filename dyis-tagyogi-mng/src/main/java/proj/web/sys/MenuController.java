...
public class MenuController extends WebBaseController {
	...
	public ModelAndView selectMenuList(HttpServletRequest request, @RequestBody(required=false) HashMap<String, Object> paramMap) {
	...
	public ModelAndView saveMenu(HttpServletRequest request, @RequestBody(required=false) HashMap<String, Object> paramMap) {
