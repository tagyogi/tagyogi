...
import proj.biz.sys.service.ReportService;
...
public class ReportController {
	...
	public ModelAndView selectReportList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView deleteReport(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
