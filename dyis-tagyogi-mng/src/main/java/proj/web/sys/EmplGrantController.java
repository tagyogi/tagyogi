...
import proj.biz.sys.service.EmplGrantService;
...
public class EmplGrantController {
	...
	public ModelAndView selectEmplGrantList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView saveEmplGrant(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
