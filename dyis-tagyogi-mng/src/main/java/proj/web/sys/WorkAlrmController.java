...
import proj.biz.sys.service.WorkAlrmService;
...
public class WorkAlrmController {
	...
	public ModelAndView selectWorkAlrmList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView saveWorkAlrm(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView updateWorkAlrmEmplChk(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
