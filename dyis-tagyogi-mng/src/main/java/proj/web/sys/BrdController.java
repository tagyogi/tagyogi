...
import proj.biz.sys.service.BrdMasService;
...
public class BrdController {
	...
	public ModelAndView selectBrdList(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
	...
	public ModelAndView selectBrd(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
		LOGGER.debug("selectBrd START");
		JsonResult result = new JsonResult();
		
		try {
			//상세
			HashMap<String, Object>getMap = brdService.selectBrd(paramMap);
	...
	public ModelAndView deleteBrd(HttpServletRequest request, @RequestBody(required = false) HashMap<String, Object> paramMap) throws Exception {
