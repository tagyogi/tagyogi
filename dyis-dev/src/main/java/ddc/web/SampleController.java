...
import ddc.service.LogProcService; /* ddc.biz.sys.service.LogProcService */
import ddc.service.SampleService;
...
public class SampleController {
	...
	public ModelAndView selectSampleList(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView selectSample(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView saveSample(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView insertSample(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView updateSample(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
	...
	public ModelAndView deleteSample(HttpServletRequest request, @RequestBody(required = false) HashMap paramMap) throws Exception {
