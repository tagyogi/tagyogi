...
public class FileUploadUtil extends BasedFileUtil {
	 ...
	 * @throws Exception
	 */
	public static List<HashMap> uploadFiles(HttpServletRequest request, String atthTypNm) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static List<HashMap> uploadImgFiles(HttpServletRequest request) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static HashMap uploadPhotoFiles(HttpServletRequest request) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static HashMap uploadExcelFiles(HttpServletRequest request, String sFolder) throws Exception {
