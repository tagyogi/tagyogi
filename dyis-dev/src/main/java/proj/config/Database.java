...
import proj.core.datasource.JndiPropertyHolder;
 ...
 */
@Configuration 
@MapperScan(value = "proj.service.repository", annotationClass = DefaultConnMapper.class, sqlSessionFactoryRef = "defaultSqlSessionFactory")
...
public class Database {
    ...
    public SqlSessionFactory defaultSqlSessionFactory(@Qualifier("defaultDataSource") DataSource defaultDataSource, ApplicationContext applicationContext) throws Exception {
        ...
        //String packages = "proj.core.domain";
