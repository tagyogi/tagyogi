...
import proj.service.repository.DevDbMapper;
...
public class DevDbServiceImpl implements DevDbService {
	 ...
	 * @return 현황
	 */
	public void saveDevDbMasProc(HashMap<String, Object> pMap) {
		Object test = pMap.get("data");
		List<HashMap<String, Object>> getList = (List<HashMap<String, Object>>)test;
    	
    	for(int i =0; i < getList.size(); i++){
			HashMap<String, Object> getMap = (HashMap<String, Object>) getList.get(i);
	...
	public void saveDevDbDtlProc(HashMap<String, Object> pMap) throws Exception {
    	...
    	List<Object> getList = (List<Object>) pMap.get("data");
    	for(int i =0; i < getList.size(); i++){
			HashMap<String, Object> getMap = (HashMap<String, Object>) getList.get(i);
	...
	public List<HashMap<String, Object>> selectTblList(HashMap<String, Object> pMap) throws Exception {
    	List<HashMap<String, Object>> getList = DevDbMapper.selectTblList(pMap);
		return getList;
	}
