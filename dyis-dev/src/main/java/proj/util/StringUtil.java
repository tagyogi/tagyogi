...
public class StringUtil {
	 ...
	 * @see
	 */
	public static String getEncprojd(String srcString, String srcCharsetNm, String cnvrCharsetNm) {
	 ...
	 *
	 * <pre>
	 *   StringUtil.nvl("20100901", "") = "2010-09-01"
	 * </pre>
	 *
	 * @param date  입력받는 문자열
	 * @return " - "가 추가된 입력문자열
	 */
	public static String nvl(Object str, String newStr) {
		String param = "";
		
		if(str != null && !isEmpty((String)str)){
			if(str.equals("null")){
				param = newStr;
			}else{
				param = (String)str;
