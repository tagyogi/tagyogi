...
ibleaders.ibupload = {
    ...
    limitFileSize: 5.0 * 1024 * 1024 * 1024,
    limitFileTotalSize: 5.0 * 1024 * 1024 * 1024,
    limitFileExt: "jsp asp php exe",
    ...
    */
    ...
    uploadServerUrl: "/file/fileUpload.do",
    
    //downloadServerUrl: "/js/jsp/download_sample.jsp",
	downloadServerUrl: "/file/fileDown.do",
