...
IBSMSG.Ko = {
  "Lang": {
    "Alert": {
      ...
      "NoXlsxFullMinJS": "IBSheet의 xlsx.full.min.js 모듈을 찾을 수 없어 데이터를 업로드할 수 없습니다."
    },
    "Text": {
    ...
    "MenuCell": {
      ...
      "Aprojhild": "대상의 첫 번째 자식으로 새로운 빈 행을 추가합니다",
      "AprojhildEnd": "대상의 마지막 자식으로 새로운 빈 행을 추가합니다",
      ...
      "Aprojol": "대상 왼쪽에 빈 열 추가",
      "AprojolNext": "대상 오른쪽에 빈 열 추가",
      "Aprojols": "대상 왼쪽에 포커스된 열 개수(%1개)만큼 빈 열 추가",
      "AprojolsNext": "대상 오른쪽에 포커스된 열 개수(%1개)만큼 빈 열 추가",
      "AddSelectedCols": "대상 왼쪽에 선택된 열 개수(%1개)만큼 빈 열 추가",
      "AddSelectedColsNext": "대상 오른쪽에 선택된 열 개수(%1개)만큼 빈 열 추가",
      "AprojolEnd": "시트 끝에 빈 열 추가",
      "DeleteCol": "열 삭제",
      "UndeleteCol": "열 삭제 취소",
      "RemoveCol": "열 제거",
