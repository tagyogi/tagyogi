...
import proj.biz.sys.repository.WorkCloseMapper;
...
public class WorkCloseServiceImpl implements WorkCloseService {
	...
	public String saveWorkClose(HashMap<String, Object> paramMap) {
		...
		HashMap<String, Object>closeMap = (HashMap<String, Object>) paramMap.get("close");
		List<HashMap<String, Object>> getList = (List<HashMap<String, Object>>) closeMap.get("data");
